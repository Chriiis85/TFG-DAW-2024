$(document).ready(function () {
  ...
  // FUNCION QUE ESCONDE DE NUEVO EL CONTENEDOR DESPLEGABLE CUANDO PASE MEDIO SEGUNDO SIN TENER EL RATON ENCIMA
  ...
  // DESPLEGAR EL CONTENEDOR CUANDO SE HAGA HOVER O FOCUS EN EL ELEMENTO
  $("#formulaone").hover(showContainer, hideContainer).focus(showContainer);
  ...
  // MANTENER EL CONTENEDOR DESPLEGADO MIENTRAS EL TABINDEX ESTE ENCIMA DE CUALQUIER CONTENIDO DENTRO DEL CONTENEDOR
