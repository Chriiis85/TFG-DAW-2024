...
<body>
  ...
  <article class="header">
    ...
    <div class="header-container2">
      ...
      <a title="Go to Standings Page" tabindex="7" href="standings.php">SEASON STANDINGS</a>
      <a title="Go to Data Page" tabindex="8" href="data.php">
        HISTORIC DATA
      </a>
      <a title="Go to Forum Page" tabindex="9" href="forum.php">FORUM</a>
    </div>
    <div class="header-container3">
      <h1>Social Media: </h1>
      <div class="social-buttonsHeader">
        <a target="_blank" title="Go to Chris GitHub Page" tabindex="10" href="https://github.com/Chriiis85"
          class="social-buttonHeader github" aria-label="GitHub">
        ...
        <a target="_blank" title="Go to Chris LinkedIn Page" tabindex="11"
          href="https://www.linkedin.com/in/christian-moreno-díaz-109024292/" class="social-buttonHeader linkedin"
          aria-label="LinkedIn">
        ...
        <a target="_blank" title="Go to Chris Instagram Page" tabindex="12"
          href="https://www.instagram.com/christiaan.85/" class="social-buttonHeader instagram" aria-label="Instagram">
  ...
  <div id="header-drop-container-formulaone" class="header-drop-container">
    ...
    <div class="header-drop-container-options">
      <h3 tabindex="3" title="Go to About F1 Page" onclick="window.location.href = 'aboutf1.php'"><img
          src="Images/down-arrow-svgrepo-com.svg" alt="Down Arrow" />About Formula One</h3>
    </div>
    <div class="header-drop-container-options2">
      <a tabindex="4" title="Go to Drivers Page" href="drivers.php"><img src="Images/down-arrow-svgrepo-com.svg"
