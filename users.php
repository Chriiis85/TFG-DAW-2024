  ...
  <section class="main">
    ...
    <article id="formRegister" class="main-info-Register">
      <form class="main-info-Login" role="form" method="post" action="PHP/Forum/registrar_usuario.php">
        ...
        <button aria-label="Register Account" type="submit" id="register" class="buttons" role="button">Register</button>
        <button aria-label="Go Home" type="button" title="Go to Main Page" onclick="window.location.href = 'index.html'" id="home" class="buttons" role="button">
          Go Home
        </button>
      </form>
    </article>
    ...
    <article id="formLogin" class="main-info-Login">
      <form class="main-info-Login" role="form" method="post" action="PHP/Forum/validar_usuario.php">
        ...
        <button aria-label="og Into Account" type="submit" id="login" class="buttons" role="button">Login</button>
        <button aria-label="Go Home" title="Go to Main Page" onclick="window.location.href = 'index.html'" id="home" class="buttons" role="button">
          Go Home
        </button>
