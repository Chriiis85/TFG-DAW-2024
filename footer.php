...
<head>
  ...
  <title>Footer - Motoring Community</title>
  ...
  <footer id="footer">
    <section class="footer-top">
      ...
      <article class="footer-top-col2">
        ...
        <a title="Go to Main Page" href="index.html">Main Page</a>
        <a title="Go to About F1 Page" href="aboutf1.php">About Formula One</a>
        <a title="Go to ForumPage" href="forum.php">Motoring Community Forum</a>
      </article>
      <article class="footer-top-col2">
        <h1>Privacy Policy</h1>
        <div class="footer-top-col2-bar"></div>
        <a title="Go to Footer Section" href="#footer" id="privacy-policy">Privacy Policy</a>
        <a title="Go to Footer Section" href="#footer" id="data-usage">Data Usage</a>
        <a title="Go to Footer Section" href="#footer" id="cookies-usage">Cookies Usage</a>
      </article>
      <article class="footer-top-col2">
        <h1>Get Help</h1>
        <div class="footer-top-col2-bar"></div>
    ...
    <section class="footer-bot">
      <p>
        WEBPAGE MADE BY CHRISTIAN MORENO DIAZ - ALL RIGHTS RESERVED 2024®™
      </p>
    </section>
  </footer>
</body>
